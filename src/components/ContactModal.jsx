...
export default function ContactModal() {
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: '#0d1018', border: '1px solid rgba(240,165,0,0.2)',
        ...
        {/* Header */}
        <div style={{ 
          background: '#131720', padding: '1.2rem 1.5rem', 
          borderBottom: '1px solid rgba(255,255,255,0.05)',
          display: 'flex', alignItems: 'center', justifyContent: 'space-between'
        }}>
          <div>
            <h3 style={{ color: '#fff', fontSize: '1.2rem', fontWeight: 800, margin: 0 }}>Contact Us</h3>
            <p style={{ color: '#8b95a5', fontSize: '0.85rem', margin: '0.2rem 0 0 0' }}>Select a number to call or WhatsApp</p>
          </div>
        ...
        <div style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
          {OWNERS.map((owner, i) => (
            <div key={i} style={{
              display: 'flex', alignItems: 'center', justifyContent: 'space-between',
              padding: '12px 16px', background: '#131720',
